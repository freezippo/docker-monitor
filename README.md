...
Based on github repo by Stefan Prodan (repo: https://github.com/stefanprodan/dockprom.git )
...
```bash
git clone https://github.com/freezippo/docker-monitor
cd docker-monitor
...
One by one, import all 2 dashboard templates from the [grafana](https://github.com/freezippo/docker-monitor/tree/master/grafana) directory. 
...
* Monitoring services alerts  [targets.rules](https://github.com/freezippo/docker-monitor/blob/master/prometheus/targets.rules)
* Docker Host alerts  [host.rules](https://github.com/freezippo/docker-monitor/blob/master/prometheus/host.rules)
* Docker Containers alerts [containers.rules](https://github.com/freezippo/docker-monitor/blob/master/prometheus/containers.rules)
...
The notification receivers can be configured in [alertmanager/config.yml](https://github.com/freezippo/docker-monitor/blob/master/alertmanager/config.yml) file.
...
![Slack Notifications](https://raw.githubusercontent.com/freezippo/docker-monitor/master/screens/Slack_Notifications.png)
